...
from PrimeMega.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
...
async def alive_function(answers):
    ...
    msg = f"""
**[Prime Mega ❤️](https://t.me/PrimeMegaBot):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [『TØNIC』](t.me/Bukan_guudlooking)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="Check Bot's Stats",
            thumb_url="https://telegra.ph/file/1da0ff9b5983912852f83.jpg",
            input_message_content=InputTextMessageContent(
