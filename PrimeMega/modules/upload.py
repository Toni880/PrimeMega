...
from PrimeMega import telethn as bot
from PrimeMega.modules.urluploader import download_file
from PrimeMega.utils.uputils import humanbytes, progress
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                ...
                dosya,
                force_document=True,
                caption=f"Uploaded By @PrimeMegaBot",
            )
        except Exception as e:
            traceback.print_exc()
