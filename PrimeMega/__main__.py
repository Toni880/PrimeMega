...
*Hello {} !*
────────────────────────
{dispatcher.bot.first_name} is a powerful group management bot built to help you manage your group!
────────────────────
...
buttons = [
        ...
        InlineKeyboardButton(
            text=f"➕️ Add {} to your group ➕️", url=f"t.me/{BOT_USERNAME}?startgroup".format(dispatcher.bot.first_name)
        ),
    ],
    [
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text(
            f"<b>Hi I'm {dispatcher.bot.first_name}!</b>\n<b>Started working since:</b> <code>{uptime}</code>",
